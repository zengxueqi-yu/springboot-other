package com.july.exception.util;
...
public class BnException extends RuntimeException {
    ...
    public BnException(Integer code, String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
    ...
    private static BnException on(Integer code, String message, Object... args) {
        if (code == null) {
            ...
            return args == null ? new BnException("on(code/message/args)中args不允许为空") : new BnException(code, MessageFormat.format(message, args));
        }
    }
